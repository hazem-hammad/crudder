<div class="d-flex align-items-center position-relative my-1">
    <input type="text" name="name" id="name"
           class="form-control form-control-sm datatable-input" placeholder="@lang('Search '. plural_lower($moduleName))">
    &nbsp;&nbsp;
    <select class="form-select form-control-solid form-select-sm datatable-input" data-control="select2"
        ...
        <option></option>
        <option value="{{\App\Enums\ActivationType::ACTIVE->value}}"> @lang('Active') </option>
        <option value="{{\App\Enums\ActivationType::IN_ACTIVE->value}}"> @lang('Inactive') </option>
    </select>
    &nbsp;&nbsp;
